            ...
            <div className='dashboard'>
                ...
                <div className="dashboard-infographics">
                    <div className="dashboard-infographics-holdings">
                        ...
                        <div className="dashboard-infographics-footer"><Link>{`Total balance ≈ ${balance.toLocaleString('en-US', {style: 'currency', currency: 'USD'})} >`}</Link></div>
                    </div>
                    <div className='dashboard-infographics-transactions'>
                        ...
                        <div className="dashboard-infographics-footer"><Link>{'View portfolio >'}</Link></div>
                    </div>
                </div>
            </div>
        )
